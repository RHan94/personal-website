const translations = {
    "en": {
        ...
        "edu_title": "Education",
        "edu_date0": "Future Plan",
        "edu_degree0": "M.S. in Computer Science and Information Engineering (Planned)",
        "edu_org0": "National Chung Cheng University (CCU)",
        "edu_desc0_1": "Currently a student in Prof. Po-Ching Lin's laboratory.",
        ...
        "proj_role0": "Solo Developer (AI-assisted) · CCU · Jun 2026 – Ongoing",
        "proj_desc0": "Independently designed and built a vulnerability management platform integrating the OpenText WebInspect REST API. Implemented a full vulnerability lifecycle tracking workflow (remediation status management), role-based access control (ADMIN / SECURITY_CONTACT / USER), CAS SSO campus single sign-on integration, and Docker Compose deployment. Delivered a production-grade application through solo development with AI collaboration.",
        "proj_name1": "O-RAN RIC xApp Security Research",
        "proj_role1": "Security Researcher · Feb 2026 – Ongoing",
        "proj_desc1": "Analyzing CVE exposure and attack paths in the O-RAN RIC xApp architecture. Studying security risk models for Kubernetes-based telecom microservice platforms, evaluating potential threats to containerized services in near-real-time RIC, and analyzing communication and control-flow security between xApps and the RIC Platform.",
        ...
        "proj_desc3": "Developed a Nessus scan report management system using C# WinForms, SQL Server, and a PDF generation module. Implemented scan result storage, historical report management, and vulnerability tracking features, with support for comparing multiple scans to analyze whether vulnerabilities improved, disappeared, or persisted. Significantly reduced administrative overhead; planned for integration into the campus-wide information management system.",
    ...
    "zh": {
        ...
        "edu_title": "學歷",
        "edu_date0": "未來規劃",
        "edu_degree0": "資訊工程研究所 碩士（預計攻讀）",
        "edu_org0": "國立中正大學 (CCU)",
        "edu_desc0_1": "現為林柏青老師實驗室學生。",
        ...
        "proj_role0": "獨立開發（AI 協作）· 中正大學 · 2026/6 – 進行中",
        "proj_desc0": "獨立設計並開發弱點管理平台（Vulnerability Management Platform），串接 OpenText WebInspect REST API。實作弱點生命週期追蹤機制（修復狀態管理），建立 ADMIN / SECURITY_CONTACT / USER 三級角色權限控管，整合 CAS SSO 校園單一簽入，並以 Docker Compose 完成整合部署。以 Solo dev + AI 協作模式完成 production 等級應用。",
        "proj_name1": "O-RAN RIC xApp 資安研究",
        "proj_role1": "資安研究員 · 2026/2 – 進行中",
        "proj_desc1": "分析 O-RAN RIC xApp 架構之 CVE 暴露面與攻擊路徑。研究 Kubernetes-based 電信微服務平台之安全風險模型，評估 near-real-time RIC 架構中容器化服務可能之安全威脅，分析 xApp 與 RIC Platform 之間通訊與控制流程安全議題。",
        ...
        "proj_desc3": "使用 C# WinForms、SQL Server 與 PDF 產生模組開發 Nessus 掃描報告管理系統。實作掃描結果儲存、歷史報告管理與弱點追蹤功能，支援多次掃描結果比對，分析弱點改善、消失或持續存在情況。專案成效佳，大幅縮減行政流程，後續將整併至全校資訊管理系統。",
